      ...
      <div class="glass-panel-light rounded-[40px] shadow-[0_20px_60px_rgba(0,0,0,0.3)] overflow-hidden">
        <div class="p-10 md:p-12">
          <div class="flex flex-col items-center mb-10">
            ...
            <p class="text-slate-500 text-sm mt-2 font-medium">创建您的研究员账户</p>
          </div>

          <form @submit.prevent="handleSubmit" class="space-y-6">
            <div v-if="error" class="flex items-center gap-2 p-4 bg-red-50 border border-red-100 text-red-600 text-sm rounded-2xl animate-shake">
            ...
            <div class="space-y-4">
              <div class="relative group">
                ...
                <input
                  ...
                  type="text"
                  required
                  class="w-full pl-14 pr-6 py-5 bg-slate-100/50 border-2 border-transparent focus:border-blue-500 focus:bg-white rounded-2xl text-slate-800 placeholder:text-slate-400 font-bold outline-none transition-all"
                  placeholder="用户名"
                />
              </div>
            ...
            <button
              type="submit"
              :disabled="loading"
              class="w-full py-5 bg-blue-600 hover:bg-blue-700 disabled:bg-slate-400 text-white rounded-2xl font-black text-lg shadow-[0_15px_30px_rgba(37,99,235,0.3)] hover:shadow-[0_20px_40px_rgba(37,99,235,0.4)] transition-all flex items-center justify-center gap-3 transform active:scale-[0.98]"
            >
        ...
        <div class="bg-slate-50 p-6 flex justify-around border-t border-slate-100">
          <div class="flex flex-col items-center">
            <span class="text-[10px] font-black text-slate-400 uppercase tracking-widest">Protocol</span>
            <span class="text-xs font-bold text-slate-600">Secure SHA-256</span>
          </div>
          <div class="w-px h-8 bg-slate-200"></div>
          <div class="flex flex-col items-center">
            <span class="text-[10px] font-black text-slate-400 uppercase tracking-widest">Database</span>
            <span class="text-xs font-bold text-slate-600">Chemistry DB</span>
          </div>
        </div>
      </div>
    </div>
