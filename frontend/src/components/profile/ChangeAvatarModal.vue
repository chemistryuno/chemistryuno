...
<template>
  <div v-if="show" class="viewport-modal-overlay z-[100] p-4 bg-slate-900/60 dark:bg-black/80 backdrop-blur-md" @click="$emit('close')">
    ...
    <!-- 独立裁剪弹窗 -->
    <div v-if="showCropperModal" class="viewport-modal-overlay z-[110] p-2 sm:p-4 bg-black/80 dark:bg-black/95 backdrop-blur-2xl animate-in fade-in duration-300">
